...
<div class="ai-form-wrapper">
    <div class="glass-card">
        ...
        <form id="blogform">
            @csrf
            <input type="text" name="heading" placeholder="Enter your heading" required />
            <textarea rows="3" name="blog" placeholder="Enter the blog" required></textarea>
        ...
        $.ajax({
            ...
            success: function (response) {
                Swal.fire({
                    ...
                    text: response.message || 'Your blog has been saved!'
                });
                $('#blogform')[0].reset();
            },
            error: function (xhr) {
                Swal.fire({
                    icon: 'error',
                    title: 'Error',
                    text: xhr.responseJSON?.message || 'Failed to save your blog.'
                });
            }
        });
    });
