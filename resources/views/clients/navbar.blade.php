        ...
        <div class="row">
          <div class="col-md-6 d-flex align-items-center">
            <p class="mb-0 phone pl-md-2">
              ...
              <a href="https://mail.google.com/mail/u/0/#inbox"><span class="fa fa-paper-plane mr-1"></span> propello654@gmail.com</a>
            </p>
          </div>
          <div class="col-md-6 d-flex justify-content-md-end">
            <div class="social-media">
              <p class="mb-0 d-flex">
                <a href="https://www.instagram.com/propello__careercounselling?igsh=MXFwdm13a2pleTI4dQ==" class="d-flex align-items-center justify-content-center ibg"><span class="fa fa-instagram"><i class="sr-only">Instagram</i></span></a>
