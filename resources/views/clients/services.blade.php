    ...
    <section class="ftco-section bg-light">
    	...
    	<div class="container-fluid px-0">
    		<div class="row no-gutters">
    			...
    			<div class="col-md-6">
    				<div class="services-wrap d-flex">
    					<div class="img order-md-last" style="background-image: url(clients/images/services-3.jpg);"></div>
    					<div class="text">
    			...
    			<div class="col-md-6">
    				<div class="services-wrap d-flex">
    					<div class="img order-md-last" style="background-image: url(clients/images/services-4.jpg);"></div>
    					<div class="text">
